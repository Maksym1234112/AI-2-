...
for i in range(X.shape[0]):
    plt.scatter(X[i, 0], X[i, 1], marker=mapper[i], s=75, edgecolors='black', facecolor='none')
...
plt.title('Границы модели классификатора на основе К ближайших соседей')

test_datapoint = [5.1, 3.6]
plt.figure()
plt.title('Тустовая точка данных')
for i in range(X.shape[0]):
